...
1. Имя именинника
2. Telegram username (без символа @) или chat_id пользователя
3. Дату рождения в формате ГГГГ-ММ-ДД

**Как получить chat_id пользователя:**
- Если у пользователя есть публичный username, введите его без символа @
- Если username не работает или у пользователя приватный аккаунт:
  1. Попросите пользователя написать боту любое сообщение
  2. Запустите скрипт: `php get_chat_id.php`
